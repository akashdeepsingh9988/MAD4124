...
public class ShowPlayers extends AppCompatActivity implements PlayersNearby.ItemClickListener {
    ...
    PlayersNearby selectedPlayerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedPlayerAdapter = new PlayersNearby(this, playersNearBy, userLatitude, userLongitude);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (docNumber.equals("")) {
                                Game game = new Game(user.getPhoneNumber(), playersNearBy.get(pos).getPhoneNumber(), "", "", "");
                                db.collection("games")
                                        .add(game)
